...
type SDKConfig struct {
	...
	// APIKeyModelAccess limits which models each client API key can list or request.
	// Missing or empty entries allow all models for the corresponding API key.
	APIKeyModelAccess map[string][]string `yaml:"api-key-model-access,omitempty" json:"api-key-model-access,omitempty"`
